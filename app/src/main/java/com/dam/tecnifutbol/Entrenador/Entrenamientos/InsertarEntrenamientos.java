...
public class InsertarEntrenamientos {
    ...
    public static void insertarEntrenamientosDeMenos8Años() {
        ...
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Porteros', 'Menos de 8 años', 'Media', '5 minutos', 'Conos, 2 balones, 2-4 jugadores', " + R.drawable.entrenamiento_porteros_en_diagonal + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Tiro', 'Menos de 8 años', 'Media', '25 minutos', '2 balones, 2 porterías, 3-20 jugadores', " + R.drawable.entrenamiento_doble_remate_a_porteria + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Circuitos', 'Menos de 8 años', 'Media', '15 minutos', 'Conos, Picas, Colchonetas, 2 balones, 5-20 jugadores', " + R.drawable.entrenamiento_circuito_de_agilidad_regate_4 + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Pase, Tiro', 'Menos de 8 años', 'Media', '15 minutos', 'Pivotes, 1 balón, 1 portería, 3-20 jugadores', " + R.drawable.entrenamiento_pared_pase_en_profundidad_tiro + ")");
    }
    ...
    public static void insertarEntrenamientosDe8A11Años() {
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Pase, Tiro, Regate', '8 a 11 años', 'Máxima', '15 minutos', 'Pivotes, 1 balón, 1 portería, 4-24 jugadores', " + R.drawable.entrenamiento_realiza_la_pared_chuta + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Calentamiento, Velocidad', '8 a 11 años', 'Baja', '10 minutos', 'Pivotes, 12-20 jugadores', " + R.drawable.entrenamiento_las_4_esquinas + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Pase, Orientación', '8 a 11 años', 'Media', '15 minutos', 'Pivotes, Petos, 1 balón, 3-24 jugadores', " + R.drawable.entrenamiento_maniobra_pase + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Porteros', '8 a 11 años', 'Media', '10 minutos', 'Pivotes, 1 balón, 1 jugador(Portero)', " + R.drawable.entrenamiento_salto_parada + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Circuitos, Tiro', '8 a 11 años, Más de 18 años', 'Máxima', '15 minutos', 'Pivotes, Vallas, 1 balón, 1 portería, 2-24 jugadores', " + R.drawable.entrenamiento_saltos_vallas_finalizacion + ")");
    }
    ...
    public static void insertarEntrenamientosDe11A14Años() {
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Defensa', '11 a 14 años', 'Media', '20 minutos', 'Pivotes, Petos, 1 balón, 6-24 jugadores', " + R.drawable.entrenamiento_defensa_en_inferioridad_relevos + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "6-Balón colgado', " +
                "'Porteros', '11 a 14 años', 'Alta', '10 minutos', 'Pivotes, 6 balones, 1 portería, 6 jugadores, 1 portero', " + R.drawable.entrenamiento_circuito_tecnico + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Saque de banda', '11 a 14 años, Más de 18 años', 'Alta', '15 minutos', '1 balón, 1 portería, 3-20 jugadores', " + R.drawable.entrenamiento_saque_de_banda_2 + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Corners', '11 a 14 años, Más de 18 años', 'Media', '25 minutos', 'Petos, 4 balones, 2 porterías, 13-24 jugadores', " + R.drawable.entrenamiento_juego_estrategia_de_corner + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Global', '11 a 14 años', 'Media', '35 minutos', 'Pivotes, Petos, 1 balón, 6 porterías, 12-20 jugadores', " + R.drawable.entrenamiento_partido_6_porterias + ")");
    }
    ...
    public static void insertarEntrenamientosDe14A18Años() {
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Defensa', '14 a 18 años', 'Alta', '20 minutos', 'Pivotes, Petos, 1 balón, 3-24 jugadores', " + R.drawable.entrenamiento_defender_el_triangulo + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Orientación, Pase', '14 a 18 años', 'Media', '20 minutos', 'Pivotes, 2 balones, 6-24 jugadores', " + R.drawable.entrenamiento_dinamica_de_cambios_de_orientacion + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Porteros, Tiro, Pase', '14 a 18 años', 'Media', '10 minutos', '1 balón, 1 portería, 3 jugadores, 1 portero', " + R.drawable.entrenamiento_velocidad_de_reaccion_reflejos_lateralidad + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Pase, Tiro', '14 a 18 años', 'Media', '25 minutos', 'Pivotes, 1 balón, 1 portería, 3-24 jugadores', " + R.drawable.entrenamiento_finalizacion_desde_fuera_del_area + ")");
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen)" +
                ...
                "'Superioridad', '14 a 18 años, Más de 18 años', 'Alta', '25 minutos', 'Pivotes, Petos, 1 balón, 1 porterías, 10-24 jugadores', " + R.drawable.entrenamiento_superioridad_2x1_finalizacion_por_banda + ")");
    }
    ...
    public static void insertarEntrenamientosDeMas18Años() {
        MainActivity.database.execSQL("INSERT INTO entrenamientos (nombre, descripcion, tipoEjercicio, categoriaEdad, dificultad, duracion, material, imagen) " +
                ...
                "'Cabeza, Pase, Velocida', 'Más de 18 años', 'Alta', '15 minutos', 'Pivotes, Petos, 1 balón, 4-20 jugadores', " + R.drawable.entrenamiento_juego_de_cabeza + ")");
